    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <header className=" mt-3 flex flex-row items-center justify-start w-full h-15 bg-[var(--cinza-claro)] rounded-md shadow-md">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="26" viewBox="0 0 24 24" fill="none" stroke="#006eff" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <main>
                <div className="mt-10 ml-5 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="[5%]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div className="flex ml-10 gap-3">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.9" stroke-linecap="round" stroke-linejoin="round"
